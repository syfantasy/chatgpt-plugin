import K from"./MessageContentCard-cMkWF2y9.js";import{bO as M,a8 as A,cr as Q,as as f,a9 as s,ch as X,at as v,d as w,H as a,c0 as Y,T as U,ac as P,af as S,cs as q,ah as I,P as y,b9 as G,bK as J,av as z,bY as Z,j as ee,ct as te,b1 as u,b5 as ie,aL as ne,aQ as R,a_ as _,aM as oe,a$ as re,ar as se,o as g,b as x,w as b,e as C,u as h,cu as le,c as j,W as ae,Q as ce,R as me,X as de,n as ue,cv as pe}from"./index-BIBv-nvb.js";let N=!1;function he(){if(M&&window.CSS&&!N&&(N=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function fe(e){const{textColor3:o,infoColor:t,errorColor:n,successColor:i,warningColor:l,textColor1:c,textColor2:m,railColor:r,fontWeightStrong:d,fontSize:p}=e;return Object.assign(Object.assign({},Q),{contentFontSize:p,titleFontWeight:d,circleBorder:`2px solid ${o}`,circleBorderInfo:`2px solid ${t}`,circleBorderError:`2px solid ${n}`,circleBorderSuccess:`2px solid ${i}`,circleBorderWarning:`2px solid ${l}`,iconColor:o,iconColorInfo:t,iconColorError:n,iconColorSuccess:i,iconColorWarning:l,titleTextColor:c,contentTextColor:m,metaTextColor:o,lineColor:r})}const ve={common:A,self:fe},ge=f([f("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
